...
methods(Static)
    ...
    function status = status(hObject, eventdata, handles)
        ...
        %stat = horzcat('************************** * Audio Beacon: on * c: 0x00000000 * f_c: xxxxx * f_b: xxxxx * c_r: xxx ************************** * PWM: * Dir. ',num2str((50).*rand(1)+150),' * Mot. ',num2str((50).*rand(1)+150),' ************************** * Sensors: * Dist. L ',num2str((100).*rand(1)),' R ',num2str((100).*rand(1)),' * V_batt ',num2str((10).*rand(1)+20),' V ********************');

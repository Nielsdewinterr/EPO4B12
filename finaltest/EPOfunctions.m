...
methods(Static)
    ...
    function [distL,distR] = status()
        ...
        OP = input('left(0)/right(1)/straight(2)/nothing(3)/close(4)');
        if OP == 0 
        ...
        elseif OP == 2
            stat = horzcat('************************** * Audio Beacon: on * c: 0x00000000 * f_c: xxxxx * f_b: xxxxx * c_r: xxx ************************** * PWM: * Dir. ',num2str((50).*rand(1)+150),' * Mot. ',num2str((50).*rand(1)+150),' ************************** * Sensors: * Dist. L ','50',' R ','50',' * V_batt ',num2str((10).*rand(1)+20),' V ********************');
        elseif OP == 3
